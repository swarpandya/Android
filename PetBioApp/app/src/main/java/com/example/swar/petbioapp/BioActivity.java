...
public class BioActivity extends AppCompatActivity {
    ...
    public void setUp(String name, String bio){
        ...
        if(name.equals("Dufus")){
            petImageView.setImageDrawable(getResources().getDrawable(R.drawable.grumpydog));
            petName.setText(name);
            petBio.setText(bio);

        } else if(name.equals("Jarvis")){
            petImageView.setImageDrawable(getResources().getDrawable(R.drawable.grumpycat));
            petName.setText(name);
            petBio.setText(bio);
